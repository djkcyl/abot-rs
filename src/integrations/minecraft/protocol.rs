...
use crate::integrations::minecraft::codec;
use crate::integrations::minecraft::component::Component;
use crate::integrations::minecraft::legacy;
use crate::integrations::minecraft::srv;
use crate::integrations::minecraft::status::{Modpack, Players, StatusResponse, Version};
...
pub async fn ping_as(address: &str, version: &str, opts: &PingOptions) -> Result<PingResult, PingError> {
    ...
    o.protocol_version = crate::integrations::minecraft::versions::protocol_for(version).unwrap_or(-1);
...
/// [`PROXY_PROBE_LADDER`](crate::integrations::minecraft::versions::PROXY_PROBE_LADDER) 从较新稳定版往老试,命中(非占位)即返回。
