...
use crate::integrations::minecraft::color::Color;
use crate::integrations::minecraft::component::{Component, ResolvedStyle, Span};
use crate::integrations::minecraft::font::{self, Glyph, GlyphSource};
use crate::integrations::minecraft::protocol::PingResult;
...
fn info_line2(result: &PingResult) -> Vec<Span> {
    use crate::integrations::minecraft::status::ModLoader;
